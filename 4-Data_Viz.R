...
# Many data frames arenaturally in "wide" form. 
# To plot this data with ggplot2 te data must be transformed into "long" form. 

data(nile)
head(nile)

nile_dat <- melt(nile,idvar="Year",measure.vars=month.abb,
...
nile_dat_long$Date <- paste(with(nile_dat_long,Date<- paste(Month,"-","15","-",
